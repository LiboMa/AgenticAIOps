...
_current_agent_tier: SecurityTier = SecurityTier.T0_READONLY
...
def set_agent_context(agent_id: str, max_tier: SecurityTier) -> None:
    ...
    global _current_agent_tier, _current_agent_id
    _current_agent_tier = max_tier
    ...
    def decorator(fn: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> str:
            ...
            try:
                ...
                if _current_agent_tier < tier:
                    raise SecurityViolation(
                        "TIER_GATE",
                        f"Agent '{_current_agent_id}' has tier {_current_agent_tier.name} "
                ...
                logger.info(
                    ...
                    tool_name, skill, _current_agent_id, tier.name, invocation_id,
                )
                return result
                ...
                logger.warning(
                    ...
                    tool_name, skill, _current_agent_id, tier.name,
